 ...
 <div id="program-${pidx}-page" data-role="page" data-theme="b">\
    ...
    <div data-role="content">\
        <table class="program-table">\
            ...
            {{each day}}\
                <tr><th>${day_name}</th>{{each temperature}}<td  class="pgm-T" id="PT-${pidx}-${didx}-${tidx}" class="T${tindex}">${value}°</td>{{/each}}<td><a data-rel="dialog" href="#daily-program-${dpgidx}-page">P${dpgidx}</a></td></tr>\
            {{/each}}\
            </tbody>\
        </table>\
    </div>\
